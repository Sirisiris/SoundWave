        ...
        <AppBar position='fixed' style={{backgroundColor: "transparent", background: "linear-gradient(0deg, rgba(255,255,255,0) 0%, rgba(47,48,58,0.742734593837535) 37%, rgba(47,48,58,1) 86%)", boxShadow: "0px 0px 0px 0px", paddingTop: "2%"}}>
            <Toolbar>
                ...
                <Box style={{marginRight: "20%"}}>
                    <Button style={{color: "white", fontFamily: "Poppins", fontWeight: "300", fontSize: "1.2rem", textTransform: "capitalize", marginRight: "2rem"}}>Discover</Button>
                    <Button style={{color: "white", fontFamily: "Poppins", fontWeight: "300", fontSize: "1.2rem", textTransform: "capitalize"}}>Join</Button>
                </Box>
            </Toolbar>
        </AppBar>
    )
